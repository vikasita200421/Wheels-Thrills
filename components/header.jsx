    ...
    return <>
        {
            ...
            <header id="header">
                ...
                <Navbar bg="dark" data-bs-theme="dark" collapseOnSelect expand="lg" className="bg-body-tertiary header-line-1">
                    <Container>
                        <Navbar.Brand as={Link} to="/">Wheels&Thrills</Navbar.Brand>
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav">
                            <Nav className="me-auto">
                                ...
                                <Nav.Link as={Link} to="/sales" eventKey="i">Sales</Nav.Link>
                    ...
                    <Row className="justify-content-md-center text-center">
                        <Col xs={12} md={8}>
                            ...
                            <span className="fs-6">
                                ...
                                <a href="https://www.google.com/maps/place/Coimbatore,+Tamil+Nadu/@11.0139578,76.8848329,12z/data=!3m1!4b1!4m6!3m5!1s0x3ba859af2f971cb5:0x2fc1c81e183ed282!8m2!3d11.0168445!4d76.9558321!16zL20vMDE5ZmM0?entry=ttu" target="_blank" className="text-white">Coimbatore</a>
                            </span>
                                </Col>
                                <Col xs={12} md={4}>
                          <span className="fs-6">

              ...
              <Col>
                <Row>
                  <Col>
                    ...
                    <p className="fs-6 text-white m-0 mb-1">Stay updated on our latest offers, new arrivals, and automotive tips. <br/>Subscribe to our newsletter and be the first to know about exclusive deals and promotions.</p>
                  ...
                  <span>
                    ...
                    <a href="https://goo.gl/maps/2rkkAA9FP5pegCXF9" target="_blank" className="text-white">Coimbatore</a>
                  </span>
                      <br/>
                      <span>
                    <BsTelephoneFill size="0.9em" className="header-line-2-icon"/>&nbsp;
                        <a href="tel:+12126583916" target="_blank" className="text-white">(0422) 658-3916</a>
                  </span>
                      <br/>
                      <span>
                    <GrMail className="header-line-2-icon"/>&nbsp;
                        <a href="mailto:fbatuhanr@gmail.com" target="_blank" className="text-white">wheelsNthrills@gmail.com</a>
                  </span>
                    </p>
            ...
            <Row>
              <Col>
                <p className="text-white text-center fs-6 mt-2 mb-1">
                  ...
                  <a href="https://github.com/fbatuhanr/" target="_blank" className="text-primary">official Wheels&Thrills</a>
                </p>
              </Col>
            </Row>
          </Container>
